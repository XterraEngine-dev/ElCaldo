...
public class CaldoWelcomeActivity extends WelcomeActivity {
    ...
    protected WelcomeScreenConfiguration configuration() {
        return new WelcomeScreenBuilder(this)
                ...
                .basicPage(R.drawable.tamales_main_activity, getString(R.string.title_addrecipes_wizard), getString(R.string.text_addrecipes_wizard), R.color.red_background)
                ...
                .basicPage(R.drawable.kitchenuser_main_activity, getString(R.string.recetas_semana_drawer), getString(R.string.text_recipes_week), R.color.blue_background)
                .swipeToDismiss(true)
